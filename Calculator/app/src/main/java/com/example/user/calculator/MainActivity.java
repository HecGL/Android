...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Text
        current_tx = (TextView)findViewById(R.id.textViewCurrent);
        total_tx = (TextView)findViewById(R.id.textViewTotal);
        oper_tx = (TextView)findViewById(R.id.textViewOper);
    ...
    public void Operate(String newoper){
        try {
            //Toma el ultimo operador antesde pulsar
